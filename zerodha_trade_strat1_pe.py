...
def strat1_pe(
    ...
    if ma_calc == True:
        ...
        if (
            ...
            tradebook_strat1_pe = pd.read_excel("tradebook_strat1_pe.xlsx")
            new_df = pd.DataFrame(
                {
            ...
            tradebook_strat1_pe = pd.concat(
                [tradebook_strat1_pe, new_df], ignore_index=True
            )
            tradebook_strat1_pe.to_excel("tradebook_strat1_pe.xlsx", index=False)
