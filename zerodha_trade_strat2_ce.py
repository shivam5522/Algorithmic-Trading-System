...
def strat2_ce(
    ...
    if ma_calc == True:
        ...
        if (
            ...
            tradebook_strat2_ce = pd.read_excel("tradebook_strat2_ce.xlsx")
            new_df = pd.DataFrame(
                {
            ...
            tradebook_strat2_ce = pd.concat(
                [tradebook_strat2_ce, new_df], ignore_index=True
            )
            tradebook_strat2_ce.to_excel("tradebook_strat2_ce.xlsx", index=False)
